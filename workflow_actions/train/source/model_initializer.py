...
from architectures.model_components.temporal_compressor.convolutional.conv1d_block_with_dilation_with_skip import Conv1DBlockWithDilationWithSkip
from architectures.model_components.temporal_compressor.convolutional.conv1d_block_with_dilation_no_skip import Conv1DBlockWithDilationNoSkip
from architectures.model_components.temporal_compressor.convolutional.conv1d_block_no_dilation_with_skip import Conv1DBlockNoDilationWithSkip
from architectures.model_components.temporal_compressor.convolutional.conv1d_block_no_dilation_no_skip import Conv1DBlockNoDilationNoSkip
from architectures.model_components.temporal_compressor.convolutional.conv2d_with_skip import Conv2DBlockWithSkip
from architectures.model_components.temporal_compressor.convolutional.conv2d_no_skip import Conv2DBlockNoSkip
...
class ModelInitializer:
    ...
    def get_model_assembly(self, assembly_config: dict) -> "Assembly":
        ...
        return self.initializer_map[assembly_class_name](assembly_config, assembly_class_name)

    def _rnn_dense_assembly_init(self, assembly_config: dict, assembly_class_name: str) -> "Assembly":
    ...
    def _cnn_assembly_init(self, assembly_config: dict, assembly_class_name: str) -> "Assembly":
        ...
        if not classifier_cfg:
            raise KeyError("assembly_config doesn't contain `classifier` key")
        assembly = self.assembly_map[assembly_class_name]()
        temporal_compressor_cfg["ConvCls"] = self.conv_cls_map[temporal_compressor_cfg["ConvCls"]]
